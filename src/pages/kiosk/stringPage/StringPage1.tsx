...
import styles from './StringPage1.module.css';
...
import string11 from '@/assets/kiosk/string_1_1.png';
import string12 from '@/assets/kiosk/string_1_2.png';

export const StringPage1: React.FC = () => {
